    ...
    return {
        ...
        <nav class="side-navbar col-sm-2">
          <ul class="list-unstyled">
              <li class="active"><a href="#Analytics" aria-expanded="false" data-toggle="collapse">  Analytics </a>
                <ul id="Analytics" class="list-unstyled ">
                  <li class="active" ><a href="#salesAnalytics" aria-expanded="false" data-toggle="collapse"><i class="fa fa-line-chart" aria-hidden="true"></i>Sales Analytics</a>
